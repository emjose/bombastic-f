...
class SideBarContainer extends Component {
  ...
  getColorOptions=()=>{
    let colorArray = ["Red", "Orange", "Yellow", "Olive", "Green", "Teal", "Blue", "Violet", "Purple", "Pink", "Brown", "White", "Grey", "Black", "Multicolor"]
  ...
  getMenuItems=()=>{
   ...
   let termArray = ["All","Casual", "Athletic", "Dress", "Hiking", "Compression", "Pack", "Pride"]
